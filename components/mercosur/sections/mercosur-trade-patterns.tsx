...
import { MercosurTradeShareChart } from "@/components/mercosur/charts/mercosur-trade-share-chart"

export function MercosurTradePatterns() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4 rounded-lg border border-slate-300 bg-white p-6">
        ...
        <MercosurTradeShareChart country={selectedCountry} />
      </div>
...
export default MercosurTradePatterns

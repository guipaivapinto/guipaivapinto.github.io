...
import { MercosurSectorChart } from "@/components/mercosur/charts/mercosur-sector-chart"

export function MercosurBlockingDynamics() {
  return (
...
export default MercosurBlockingDynamics

...
import { MercosurWelfareChart } from "@/components/mercosur/charts/mercosur-welfare-chart"

export function MercosurUruguayGains() {
  return (
...
export default MercosurUruguayGains

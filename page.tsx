...
{activeTab === "bio" && (
  ...
  <div className="space-y-8">
    ...
    <Card>
      ...
      <CardContent>
        <p className="text-gray-700 mb-4 leading-relaxed">
          This interactive page walks through the motivation of the paper, Mercosur trade policy,
          the role of external partners, and the main quantitative results showing why countries
          such as Uruguay gain from staying and why large members have incentives to block 
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {/* Optional  iframe preview inside the main site */}
          {/* Remove this block if you prefer only the link above */}
          <div className="w-full mt-4">
            <p className="text-sm text-gray-600 mb-2">
              Preview of the interactive explainer
            </p>
            <div
            ...
            >
              <iframe
                src="/mercosur"
                title="Mercosur interactive explainer"
                className="absolute inset-0 w-full h-full border-0"
              />
            </div>
          </div>
      ...
      <CardContent>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700 mb-4">
              [Brief description of what your Shiny app does, what data it uses, and how it relates to your research]
            </p>

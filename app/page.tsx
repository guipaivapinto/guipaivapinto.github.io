                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-gray-300 pl-6">
                    ...
                    <p className="text-gray-700 mb-3">
                      This study advances a quantitative political economy analysis of development banking within
                      federative systems, focusing on Brazil's National Bank for Economic and Social Development (BNDES).
                    </p>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-gray-300 pl-6">
                    ...
                    <p className="text-gray-700 text-sm mt-1 mb-3">
                      This paper studies whether the world economy changed in ways that made the long-delayed
                      EU-Mercosur tariff bargain easier to defend. I code Annex 2-A, the product-level tariff schedule,
                      and evaluate it across benchmark economies from 2007 to 2022 in a six-region, 49-sector
                      quantitative trade model.
                    </p>
                    <p className="text-gray-700 text-sm mt-1 mb-3">
                      The tariff component generates small aggregate gains, so the main result is incidence:
                      manufacturing losses in Argentina and Brazil remain concentrated, EU agriculture remains
                      politically exposed, and external tariff-risk and strategic-input scenarios help explain why the
                      agreement became economically more relevant despite modest tariff-only effects.
                    </p>
                    <Button size="sm" variant="outline" asChild>
